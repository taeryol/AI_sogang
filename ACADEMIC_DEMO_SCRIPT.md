...
> 
> 특히 다음 두 가지 핵심 기술을 중점적으로 연구하였습니다:
> 
> 1. **지능형 검색**: 자연어 이해 + 의미/키워드 검색 결합
> 2. **출처 추적**: 답변의 신뢰성과 투명성 확보"
...
#### 🔹 4-2. 지능형 검색 시스템 (4:00 - 5:30)

**[발표]**:
> "본 연구의 첫 번째 핵심 기술은 **지능형 검색 시스템**입니다.
> 
> 이는 두 가지 기술을 결합한 것입니다."
...
> 
> **Step 1: 질문 이해**  
> 사용자가 '뭐야?', '어떻게 돼?' 같은 구어체로 질문하면,  
> GPT-3.5가 핵심 키워드를 추출합니다.  
> 예: 'RAG 기술 장점 이점'
> 
> **Step 2: 두 가지 방법으로 검색**  
> • **의미 검색**: '장점'이라는 단어가 없어도 비슷한 의미의 문서 찾기  
> • **키워드 검색**: '장점', 'RAG' 같은 정확한 단어가 있는 문서 찾기
> 
> 두 결과를 합쳐서 가장 관련 있는 내용을 찾아냅니다."
...
> • 의미적으로 비슷한 내용도 찾음
> 
> 실험 결과, 기존 방식보다 약 25% 더 정확하게 답을 찾았습니다."

---

#### 🔹 4-3. Source Citation 시스템 (5:30 - 7:00)
...
### 📌 PART 5: 개선 방향 및 향후 연구 (7:30 - 10:00)
...
> 특히 두 가지 핵심 기술을 통합했습니다:
> 
> 1. **지능형 검색**: 자연어 이해와 의미/키워드 검색 결합으로 정확도 25% 향상
> 2. **출처 추적**: 모든 답변에 클릭 가능한 출처 표시로 신뢰성 확보
> 
